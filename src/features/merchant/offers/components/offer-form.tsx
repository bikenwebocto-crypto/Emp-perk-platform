        ...
        <Card className="border-blue-200 bg-blue-50 dark:bg-blue-950/20">
          ...
          <CardContent className="p-4 text-sm">
            ...
            <p className="text-muted-foreground mt-1">
                            Your current live offer will remain visible to
              employees until the               replacement is approved.
                  ...
                  <Card className="bg-muted/30">
                    ...
                    <CardContent>
                      ...
                      <p className="text-sm text-muted-foreground">
                        ...
                        generated for this offer. Employees will scan it at the
                        merchant location to receive their redemption code.
          ...
          <div className="lg:sticky lg:top-24 lg:self-start">
            ...
            <Card className="overflow-hidden border-2">
              ...
              <CardHeader className="border-b bg-gradient-to-br from-muted/50 to-muted/20 pb-3">
                ...
                <p className="text-xs text-muted-foreground">
                                    How employees will see this offer in their
                  app                
                </p>
